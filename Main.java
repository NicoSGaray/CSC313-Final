/*
javac -classpath ".:/Users/nicogaray/Downloads/lwjgl-release-3.3.6-custom" Main.java
java -XstartOnFirstThread -classpath ".:/Users/nicogaray/Downloads/lwjgl-release-3.3.6-custom/*" Main
*/
...
public class Main
{
 ...
 public void initLighting()
 {
   ...
   FloatBuffer diffuseLight = BufferUtils.createFloatBuffer(4).put(new float[] {1.0f, 1.0f, 1.0f, 1.0f});    // Set material properties
...
// Increase diffuse light
 ...
 private void gluLookAt(float eyex, float eyey, float eyez, float centerx, float centery, float centerz, float upx, float upy, float upz)
 {
   ...
   viewMatrix.put(new float[] {side[0], up[0], -forward[0], 0, side[1], up[1], -forward[1], 0, side[2], up[2], -forward[2], 0, -dotProduct(side, new float[] {eyex, eyey, eyez}), -dotProduct(up, new float[] {eyex, eyey, eyez}), dotProduct(forward, new float[] {eyex, eyey, eyez}), 1});
...
class Car
{
 ...
 public void turnLeft() { angle += turnSpeed; }

 public void turnRight() { angle -= turnSpeed; }
